    ...
    $.mobiscroll.classes.Scroller = function (elem, settings) {
        ...
        */
        that.position = function (check) {
            ...
            if (/modal|bubble/.test(s.display)) {
                ...
                wr.width("100%").css('white-space', totalw > ww ? '' : 'nowrap');
            }
            d.css("width", "95%");
            mw = d.outerWidth();
            ...
            $.each(s.wheels, function (i, wg) { // Wheel groups
                ...
                $.each(wg, function (j, w) { // Wheels
                    ...
                    html += '<td><div class="dwwl dwrc dwwl' + l + '">'
                        + (s.mode != 'scroller'
                            ? '<a href="#" tabindex="-1" class="dwb-e dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span></span></a>' +
                              '<a href="#" tabindex="-1" class="dwb-e dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></a>'
                            : '')
                        ...
                        + (
                            s.fixedWidth
                                ? ('width:' + (isFixw ? s.fixedWidth[l] : s.fixedWidth) + 'px;')
                                : (
                                    s.minWidth
                                        ? ('min-width:' + (isMinw ? s.minWidth[l] : s.minWidth) + 'px;')
                                        : 'min-width:' + s.width + 'px;')
                                    + (s.maxWidth
                                        ? ('max-width:' + (isMaxw ? s.maxWidth[l] : s.maxWidth) + 'px;') : '')
                                ) + '">'
                        +'<div class="dw-ul">';
                    // Create wheel values
        ...
        */
        that.init = function (ss) {
            ...
            // Add default buttons
            s.buttons = s.buttons || ['cancel','set'];
